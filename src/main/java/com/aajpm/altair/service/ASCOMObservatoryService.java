...
//     //#region Managed Services & Components
...
//     @Override
//     public Mono<Void> start(boolean parked) throws DeviceUnavailableException {
//         if (!parked) {
//             startAwait();
//         } else {
//             telescope.connect();
...
//     @Override
//     public Mono<Void> abortJob() throws DeviceException {
...
//     @Override
//     public Mono<Void> reset() throws DeviceException {
//         this.state = ObservatoryService.State.IDLE;
//     }
